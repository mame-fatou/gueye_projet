...
$rep = $bdd->query('select POURCENTAGE from FREQUENTATION where NOM_GARE="Lyon Saint Exupery TGV" and ANNEE=2016 order by POURCENTAGE') ;
...
$graph->title->Set('Lyon Saint Exupery TGV');
