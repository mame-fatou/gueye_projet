...
$rep = $bdd->query('select POURCENTAGE from FREQUENTATION where NOM_GARE="Valence TGV Rhône-Alpes Sud" and ANNEE=2015 order by POURCENTAGE') ;
...
$graph->title->Set('Valence TGV Rhône-Alpes Sud');
$graph->title->SetMargin(10);
 
//$graph->subtitle->SetFont(FF_ARIAL, FS_BOLD, 10);
$graph->subtitle->Set('2015');
