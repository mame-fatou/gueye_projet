...
$rep = $bdd->query('select POURCENTAGE from FREQUENTATION where NOM_GARE="Toulouse Matabiau" and ANNEE=2014 order by POURCENTAGE') ;
...
$graph->title->Set('Toulouse Matabiau');
