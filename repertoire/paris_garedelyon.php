...
$rep = $bdd->query('select POURCENTAGE from FREQUENTATION where NOM_GARE="Paris Gare de Lyon" and ANNEE=2012 order by POURCENTAGE') ;
...
$graph->title->Set('Paris Gare de Lyon');
