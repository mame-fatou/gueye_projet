...
$rep = $bdd->query('select POURCENTAGE from FREQUENTATION where NOM_GARE="Paris Austerlitz" and ANNEE=2013 order by POURCENTAGE') ;
...
$graph->title->Set('Paris Austerlitz');
