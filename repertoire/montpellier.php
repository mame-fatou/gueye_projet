...
$rep = $bdd->query('select POURCENTAGE from FREQUENTATION where NOM_GARE="Montpellier Saint-Roch" and ANNEE=2015 order by POURCENTAGE') ;
...
$graph->title->Set('Montpellier Saint-Roch');
