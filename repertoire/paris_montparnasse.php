...
$rep = $bdd->query('select POURCENTAGE from FREQUENTATION where NOM_GARE="Paris Montparnasse 1 et 2 + Vaugirard" and ANNEE=2012 order by POURCENTAGE') ;
...
$graph->title->Set('Paris Montparnasse 1 et 2 + Vaugirard');
$graph->title->SetMargin(10);
 
//$graph->subtitle->SetFont(FF_ARIAL, FS_BOLD, 10);
$graph->subtitle->Set('2012');
